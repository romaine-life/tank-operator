...
export class GeminiTankEventAdapter {
  ...
  // Durable per-turn usage snapshot. Parallels the codex/claude adapters'
  // turn.usage emission so Gemini token counts render in the transcript and
  // feed the usage surface.
  turnUsage(
