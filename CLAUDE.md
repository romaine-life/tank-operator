...
Web frontend over a thin K8s orchestrator that spawns ephemeral session pods on demand. The launcher creates GUI/headless agent sessions backed by Kubernetes pods. See [README.md](README.md) for the layout.
