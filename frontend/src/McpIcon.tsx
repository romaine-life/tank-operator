...
export const McpIcon = forwardRef<
  SVGSVGElement,
  ComponentProps<"svg"> & { size?: string | number; strokeWidth?: string | number }
>(function McpIcon({ size = 24, strokeWidth = 2, ...props }, ref) {
  const scaledStrokeWidth = typeof strokeWidth === "number" ? strokeWidth * 6 : strokeWidth;
