...
- [`mcp-azure-personal`](https://github.com/nelsong6/mcp-azure-admin) — first-party personal Azure MCP server and chart. The runtime name has moved off "admin"; the GitHub repo slug still needs an admin rename.
