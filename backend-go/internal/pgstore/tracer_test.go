...
func TestOperationFromSQL(t *testing.T) {
	cases := map[string]string{
		...
		"INSERT INTO avatar_upload_attempts (id, stage, result) VALUES ($1, $2, $3)":       "insert_avatar_upload_attempts",
		"SELECT id FROM avatar_upload_attempts WHERE id = $1":                              "select_avatar_upload_attempts",
		"UPDATE avatar_upload_attempts SET result = $1 WHERE id = $2":                      "update_avatar_upload_attempts",
