...
type chatScrollMetricEvent struct {
	...
	RouteSessionID              string   `json:"routeSessionId,omitempty"`
	SelectedTurnID              string   `json:"selectedTurnId,omitempty"`
...
var chatScrollStructuredLogEvents = map[string]struct{}{
	...
	"turn-directory-new-turn-loop":                  {},
	"turn-directory-route-session-mismatch":         {},
...
func logChatScrollClientEvent(email string, event chatScrollMetricEvent) {
	...
	slog.Info("browser chat scroll event",
		...
		"previous_session_id", boundedChatScrollLogString(event.PreviousSessionID, 80),
		"route_session_id", boundedChatScrollLogString(event.RouteSessionID, 80),
		"selected_turn_id", boundedChatScrollLogString(event.SelectedTurnID, 120),
		...
		"key", boundedChatScrollLogString(event.Key, 80),
