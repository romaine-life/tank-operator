...
func (s *appServer) registerRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/sessions/{session_id}/questions", s.handleSessionQuestions)
	mux.HandleFunc("GET /api/sessions/{session_id}/questions/{question_set_id}", s.handleSessionQuestion)
